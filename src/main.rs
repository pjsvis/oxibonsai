...
mod cli {
    ...
    pub async fn run() -> anyhow::Result<()> {
        ...
        // Validate TOML config before using values (Bug #3 fix)
        config.validate()?;        let tracing_config =
        ...
        match cli.command {
            ...
            Commands::Chat {
                ...
                loop {
                    ...
                    // Add user input to history first (Bug #1 fix: history must include user turns)
